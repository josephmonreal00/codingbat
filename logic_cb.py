...
def date_fashion(you, date):
  	if date <= 2 and you > 2 or date > 2 and you <= 2 or date == 2 and you == 2:
    	return 0
  	elif date >= 8 and you >= 3 or date >= 3 and you >= 8:
    	return 2
  	else:
    	return 1
...
def alarm_clock(day, vacation):
	if day == 1 and vacation == False:
		return "7:00"
  	elif day == 2 and vacation == False:
    	return "7:00"
  	elif day == 3 and vacation == False:
    	return "7:00"
  	elif day == 4 and vacation == False:
    	return "7:00"
  	elif day == 5 and vacation == False:
    	return "7:00"
  	elif day == 1 and vacation == True:
    	return "10:00"
  	elif day == 2 and vacation == True:
    	return "10:00"
  	elif day == 3 and vacation == True:
    	return "10:00"
  	elif day == 4 and vacation == True:
    	return "10:00"
  	elif day == 5 and vacation == True:
    	return "10:00"
  	elif day == 0 and vacation == False:
    	return "10:00"
  	elif day == 6 and vacation == False:
    	return "10:00"
  	else:
    	return "off" 
...
def love6(a, b):
	sum = a + b
  	minus = abs(a - b)
  	minus_ = abs(b - a)
  	if a == 6 or b == 6 or sum == 6 or minus == 6 or minus_ == 6:
  		return True
  	return False
...
def near_ten(num):
  	leftover = num % 10
  	if leftover <= 2 or 10 - leftover <= 2:
    	return True
  	else:
   		return False